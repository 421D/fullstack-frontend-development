...
Page({
  data: {
    ...
    device: [
      ...
      { iconurl: '/images/icon/ditu.png', title: '地图显示', tap: 'showMap' },
      { iconurl: '/images/icon/shizhong.png', title: '指南针', tap: 'showCompass' },
      { iconurl: '/images/icon/dqian.png', title: '当前位置、速度', tap: 'showLonLat' },
      { iconurl: '/images/icon/yyy.png', title: '摇一摇', tap: 'shake' },
      { iconurl: '/images/icon/wm.png', title: '二维码', tap: 'scanQRCode' }
    ],
    api: [
      { iconurl: '/images/icon/fenx.png', title: '下载pdf、word文档', tap: 'downloadDocumentList' },
